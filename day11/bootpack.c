    ...
    while (1) {
        ...
        if((fifo8_status(&keyfifo) + fifo8_status(&mousefifo) + fifo8_status(&timerfifo) + fifo8_status(&timerfifo2) + fifo8_status(&timerfifo3)) == 0){
            ...
            if(fifo8_status(&keyfifo)){
                ...
                key = fifo8_get(&timerfifo3);
                io_sti();
                if(key != 0){
                    timer_init(timer3, &timerfifo3, 0);
                    box_fill8(buf_back, binfo->scrnx, COL8_FFFFFF, 8, 96, 12, 110);
                }else{
                    timer_init(timer3, &timerfifo3, 1);
                    box_fill8(buf_back, binfo->scrnx, COL8_008484, 8, 96, 12, 110);
